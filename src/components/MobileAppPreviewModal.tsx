...
export const MobileAppPreviewModal: React.FC<MobileAppPreviewModalProps> = ({
 ...
 <button
 onClick={onClose}
 className="mt-4 px-6 py-2.5 rounded-xl hover:bg-slate-700 text-white font-bold text-xs border border-slate-700 transition"
 >
 ...
 <div className="relative w-[340px] h-[680px] rounded-[48px] border-[10px] border-slate-800 shadow-2xl overflow-hidden ring-1 ring-white/10 flex flex-col shrink-0">
 
 {/* Phone Speaker Notch */}
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-36 h-5 rounded-b-2xl z-40 flex items-center justify-center">
 ...
 className="w-full px-2 py-1 rounded-lg bg-black/30 text-white font-mono text-xs border focus:outline-none"
 />
 </div>
 ...
 <div className="p-2.5 rounded-xl border border-slate-800 flex flex-col items-center justify-center space-y-1">
 ...
 <div className="p-2.5 rounded-xl border border-slate-800 text-[11px]">
 ...
 <div className="p-3 rounded-xl border border-slate-800 space-y-1">
