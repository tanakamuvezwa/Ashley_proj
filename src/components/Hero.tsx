...
export const Hero: React.FC<HeroProps> = ({
 ...
 className="w-full sm:w-auto px-8 py-4 rounded-2xl hover: text-white font-bold text-base border border-slate-700/80 hover:border-emerald-500/50 transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer"
 >
