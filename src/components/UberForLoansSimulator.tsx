...
export const UberForLoansSimulator: React.FC<UberForLoansSimulatorProps> = ({ currentUser }) => {
 ...
 <div className="mt-4 md:mt-0 flex items-center space-x-3 p-3 rounded-xl border shrink-0">
 ...
 {!kycVerified ? (
 <div className="glass-card p-6 sm:p-8 rounded-3xl border shadow-2xl space-y-6">
 ...
 <div className="relative border border-dashed hover: rounded-xl p-4 text-center cursor-pointer transition">
 <input
 type="file"
 ...
 <div className="glass-card p-6 sm:p-8 rounded-3xl border shadow-2xl relative space-y-6">
 ...
 className="w-full glass-input px-3.5 py-2.5 rounded-xl text-xs text-white h-20 resize-none"
 required
 />
 </div>
 ...
 {isEvaluating && (
 <div className="glass-card p-6.5 rounded-2xl border text-center space-y-4">
 ...
 <div 
 key={offer.id} 
 className="glass-card p-5 rounded-2xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:border-emerald-500/45 transition"
 >
 ...
 <div className="p-4 rounded-xl border inline-block text-[11px] font-mono text-left space-y-1 text-slate-400">
 ...
 <div key={loan.id} className="p-4.5 rounded-2xl border hover: transition space-y-4 flex flex-col justify-between">
 ...
 <div className="pt-3.5 border-t flex items-center justify-between text-[10px] leading-none">
 <div>
