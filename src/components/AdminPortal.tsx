  ...
  return (
    <section className="py-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-8">
        ...
        <button 
          onClick={fetchData}
          className="mt-4 md:mt-0 flex items-center space-x-2 px-4 py-2.5 bg-slate-900 border border-white/10 hover:border-white/20 rounded-xl text-xs font-bold text-slate-200 transition cursor-pointer"
        >
      ...
      <div className="flex space-x-1.5 border-b border-white/5 pb-4">
        {[
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-5 py-2.5 rounded-xl text-xs font-bold transition cursor-pointer ${
              activeTab === tab.id 
                ...
                : 'text-slate-400 hover:text-white hover:bg-slate-900/40 border border-transparent hover:border-white/10'
            }`}
          >
            {tab.icon}
            <span>{tab.label}</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-white/10 hover:border-white/20 text-xs font-bold text-emerald-400 transition cursor-pointer animate-pulse"
              >
            ...
            <div className="glass-card rounded-2xl border border-white/10 overflow-hidden bg-slate-950/20">
              {loading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="border-b border-white/10 bg-slate-900/60 text-slate-400 font-bold uppercase text-[9px] tracking-wider">
                            ...
                            {user.role !== 'admin' ? (
                              <>
                                <button
                                  ...
                                  className="p-1.5 rounded-lg border border-white/5 bg-slate-900 text-slate-350 hover:text-white hover:border-white/20 transition cursor-pointer"
                                >
                                ...
                                <button
                                  ...
                                  title="Delete User"
                                  className="p-1.5 rounded-lg bg-slate-900 border border-white/5 text-slate-400 hover:text-rose-400 hover:border-rose-500/50 transition cursor-pointer"
                                >
              ...
              {loading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5">
                      {projects.map((proj) => (
                        <tr key={proj.id} className="hover:bg-slate-900/20 transition">
                          <td className="p-4">
              ...
              {loading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5">
                      {loans.map((loan) => (
                        <tr key={loan.id} className="hover:bg-slate-900/20 transition">
                          <td className="p-4">
      ...
      {userModal.open && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="glass-card max-w-md w-full p-6 rounded-3xl border border-white/10 relative shadow-2xl bg-slate-905">
            <button 
              onClick={() => setUserModal({ open: false, type: 'add' })}
              className="absolute top-4 right-4 p-2 text-slate-400 hover:text-white rounded-full bg-slate-900 border border-white/5 transition"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <form onSubmit={handleUserSubmit} className="space-y-4 text-xs">
              <div>
                ...
                <input 
                  ...
                  className="w-full glass-input px-3.5 py-2.5 rounded-xl text-xs bg-slate-950/50 text-white"
                  required
                />
              </div>
              <div>
      ...
      {projectModal.open && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="glass-card max-w-lg w-full p-6 rounded-3xl border border-white/10 relative shadow-2xl bg-slate-905">
            <button 
            ...
            <form onSubmit={handleProjectSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full glass-input px-3 py-2.5 rounded-xl text-xs bg-slate-950/50 text-white"
                    required
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full glass-input px-3 py-2 rounded-xl text-xs bg-slate-950/50 text-white"
                    required
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full glass-input px-3 py-2.5 rounded-xl text-xs bg-slate-950/50 text-white h-24 resize-none"
                  required
                />
              </div>
            ...
            <form onSubmit={handleLoanSubmit} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full glass-input px-3 py-2.5 rounded-xl text-xs bg-slate-950/50 text-white h-20 resize-none"
                  required
                />
              </div>
