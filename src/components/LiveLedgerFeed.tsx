    ...
    <div className="glass-card p-6 rounded-3xl border-slate-800 my-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-3">
        {transactions.map((tx, idx) => (
          <div 
            key={idx}
            className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-emerald-500/40 transition flex flex-col md:flex-row md:items-center justify-between text-xs gap-3"
          >
            <div className="flex items-center space-x-3">
