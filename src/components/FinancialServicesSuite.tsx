...
export const FinancialServicesSuite: React.FC = () => {
 ...
 <div className="p-4 rounded-xl border border-slate-800 flex items-center justify-between font-mono">
 ...
 <div className="p-3 rounded-xl border border-slate-800/80 text-[11px] text-slate-300 space-y-1">
 ...
 <div 
 key={prod.id}
 className="p-5 rounded-2xl border border-slate-800 hover:border-amber-500/40 transition flex flex-col md:flex-row md:items-center justify-between gap-4"
 >
 ...
 <span key={i} className="text-[10px] text-slate-300 p-1 px-2 rounded border border-slate-800">
 ✓ {f}
 </span>
 ))}
 </div>
 ...
 className="mt-2 px-4 py-2 rounded-xl hover:bg-amber-500 hover:text-slate-950 text-white font-bold text-xs transition border border-slate-700 cursor-pointer"
 >
 Attach Policy
 </button>
 </div>
