...
export const AiAdvisorWidget: React.FC = () => {
 ...
 className="relative group p-4 rounded-2xl bg-gradient-to-r from-emerald-500 via-emerald-600 to-amber-500 text-slate-950 font-bold shadow-2xl shadow-emerald-900/50 hover:scale-105 transition-all duration-300 flex items-center space-x-2.5 cursor-pointer border ring-4 ring-emerald-500/20"
 >
 ...
 className="w-full text-left p-1.5 px-2.5 rounded-lg hover:bg-emerald-500/20 text-emerald-300 text-[10px] font-semibold border border-slate-800 flex items-center justify-between transition"
 >
 <span>{qa.label}</span>
