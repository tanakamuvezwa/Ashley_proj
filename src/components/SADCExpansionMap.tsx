...
export const SADCExpansionMap: React.FC = () => {
 ...
 <div className="mt-4 md:mt-0 flex items-center space-x-3 p-2.5 rounded-2xl border border-slate-800 text-xs">
 ...
 <span className="px-3 py-1 rounded-full text-amber-400 text-xs font-mono font-bold border border-slate-800">
 ...
 <div key={idx} className="p-3 rounded-xl border border-slate-800 text-xs text-slate-200 font-semibold flex items-center space-x-2">
 ...
 <span key={idx} className="px-3 py-1 rounded-lg border border-slate-700 text-slate-300 text-xs font-medium flex items-center space-x-1.5">
