...
export const LandingPage: React.FC<LandingPageProps> = ({
 ...
 return (
 <div className=" text-slate-100 font-sans relative overflow-hidden">
 ...
 <div className="relative w-56 h-56 rounded-full border border-emerald-500/20 shadow-2xl flex items-center justify-center overflow-hidden">
 ...
 <div className="p-5 rounded-3xl border shadow-xl relative group hover:border-emerald-500/50 transition duration-300">
 ...
 <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t space-y-10">
 ...
 <div 
 key={idx}
 className="glass-card p-6 rounded-2xl border flex flex-col justify-between hover: hover: transition duration-300 group"
 >
 <div className="space-y-4">
 <div className="p-2.5 rounded-xl border inline-block shrink-0">
 {item.icon}
 </div>
 ...
 className="mt-6 w-full py-2.5 rounded-lg group-hover: text-slate-300 group-hover:text-white border group-hover: text-[10px] font-bold uppercase transition flex items-center justify-center space-x-1 cursor-pointer"
 >
 ...
 <div key={i} className="glass-card p-6.5 rounded-2xl border flex flex-col justify-between space-y-5 relative">
 ...
 <div className="w-10 h-10 rounded-xl overflow-hidden aspect-square border shrink-0">
 ...
 <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t text-center space-y-10">
 ...
 <div key={idx} className="p-5 rounded-2xl border space-y-4 hover: transition">
