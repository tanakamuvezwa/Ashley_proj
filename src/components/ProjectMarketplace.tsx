...
export const ProjectMarketplace: React.FC<ProjectMarketplaceProps> = ({ currentUser }) => {
 ...
 {/* Header & Controls */}
 <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 border-b pb-8">
 <div>
 ...
 <span className="px-3 py-1 rounded-full backdrop-blur-md border border-slate-700 text-xs font-bold text-emerald-400">
 {pitch.category}
 </span>
 </div>
 ...
 <div className="absolute bottom-3 left-4 right-4 flex items-center space-x-3 backdrop-blur-md p-2.5 rounded-2xl border border-slate-800">
 <img 
 ...
 <span key={i} className="text-[10px] font-medium px-2.5 py-1 rounded-md border border-slate-800 text-slate-300">
 ✓ {h}
 </span>
 ))}
 </div>
 ...
 <div className="grid grid-cols-3 gap-2 text-center p-3 rounded-2xl border border-slate-800">
 <div>
 ...
 <div className="w-full h-2.5 rounded-full overflow-hidden border border-slate-800">
 <div 
 ...
 <div className="p-4 rounded-2xl border border-slate-800 text-xs space-y-2">
 ...
 <button
 onClick={() => setInvestModalProject(null)}
 className="px-8 py-3 rounded-xl text-white font-bold text-xs hover: transition border border-slate-700"
 >
