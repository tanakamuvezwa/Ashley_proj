...
export const FXExchangePage: React.FC = () => {
 ...
 const isUp = change >= 0;
 return (
 <div key={rate.pair} className="glass-card p-4 rounded-2xl border hover:border-emerald-500/20 transition-all group cursor-default">
 ...
 <div className="mt-3 pt-2 border-t grid grid-cols-2 gap-1 text-[8px] font-mono text-slate-500">
 ...
 <button
 onClick={swap}
 className="w-10 h-10 rounded-full border flex items-center justify-center text-emerald-400 hover:bg-emerald-600 hover:text-slate-950 hover:border-emerald-600 transition cursor-pointer"
 >
 <ArrowRightLeft className="w-4 h-4" />
 </button>
 </div>
 ...
 {/* Rate summary */}
 <div className="p-3 rounded-xl border flex items-center justify-between text-[10px] font-mono">
