...
export const InstitutionalPortal: React.FC = () => {
 ...
 <span className="text-[10px] font-bold px-2 py-0.5 rounded text-slate-300">
 {inst.country}
 </span>
 </div>
 ...
 className="flex items-center space-x-2 px-3.5 py-1.5 rounded-xl border border-slate-700 hover:border-emerald-500 transition cursor-pointer"
 >
 ...
 <input type="range" min="650" max="800" defaultValue="720" className="w-full accent-emerald-500 h-1.5 rounded" />
 </div>
 ...
 <input type="range" min="10000" max="1000000" step="10000" defaultValue={selectedProvider.maxTicketUSD} className="w-full accent-amber-500 h-1.5 rounded" />
 </div>
 ...
 <div className="p-4 rounded-2xl border border-slate-800 space-y-2 mt-4">
 ...
 <div key={index} className="p-4 rounded-2xl border border-slate-800 flex items-center justify-between text-xs">
 <div>
